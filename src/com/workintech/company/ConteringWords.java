...
public class ConteringWords {
    ...
    public static void main(String[] args) {
        ...
        String text="When the offensive resumed, the Turks received their first victory when the Greeks encountered stiff resistance in the battles of First and Second İnönü," +
                ...
                " The two victories led to Allied proposals to amend the Treaty of Sèvres where both Ankara and Istanbul were represented, but Greece refused." + " With the conclusion of the Southern and Eastern fronts, Ankara was able to concentrate more forces on the West against the Greeks."
        ...
        for (int i=0; i<array.length-1;i++){
            ...
            sum++;
            nextword=array[i+1];
            if(!nextword.equals(oldword)){
                map.put(oldword,sum);
                sum=0;
            }
        }
        for (Map.Entry entry: map.entrySet()){
            System.out.println("Kelime: "+entry.getKey()+", Tekrar sayısı: "+entry.getValue());
        }
